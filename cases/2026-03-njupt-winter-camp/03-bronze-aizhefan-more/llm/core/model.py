...
class LLMModel(nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            attention_mask: [batch, seq_len] �� None
            position_ids: [batch, seq_len] �� None
            past_key_values: KV�����б�
            use_cache: �Ƿ�ʹ��KV����
        
        Returns:
            last_hidden_state: [batch, seq_len, hidden_size]
            past_key_values: KV���棨���use_cache=True��
        """
...
def estimate_memory_usage(config: ModelConfig, batch_size: int, seq_length: int) -> Dict:
    ...
    activations_memory = (
        ...
        config.num_layers * 4 * 2  # 4������ֵ/�㣬BF16
    )
    ...
    optimizer_memory = params * 8  # AdamW״̬
